...
<div class="flex items-center justify-center w-screen h-screen">
	<div class="flex flex-col justify-center p-6 gap-4 w-full max-w-md">
		<h1 class="text-bg-100 font-pixel text-xl">PROJECT WIZARD</h1>
		<p class="text-bg-200 font-pixel">
			Project Wizard is an experimental turn-based multiplayer fighting game trying something new.
		</p>
		<button
